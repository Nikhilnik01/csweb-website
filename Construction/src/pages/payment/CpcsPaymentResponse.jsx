// src/pages/payment/CpcsPaymentResponse.jsx
    ...
    try {
      ...
      if (response.rs === 1 && response.res) {
        ...
        if (response.res.statusName === "complete") {
          ...
          response.res.statusName === "processing" &&
...
Thank you for your payment!
    ...
    a.href = url;
    a.download = `CPCS_Receipt_${sessionData.orderId}.txt`;
        ...
        <div className="bg-white rounded-lg shadow-md p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <button
                onClick={handleViewCpcs}
                className="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400 transition-colors"
              >
                Book Another CPCS Test
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              {isSuccess
                ? "Your CPCS renewal test booking payment has been processed successfully."
                : isProcessing
                  ? "Your payment is being processed. This may take a few moments."
                  : "There was an issue processing your CPCS payment. Please try again."}
            </p>
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-medium capitalize px-2 py-1 rounded text-xs ${getStatusColor(sessionData.statusName)}`}
                    >
            ...
            {isSuccess && (
              <div className="bg-blue-50 rounded-lg p-6 mb-8 text-left">
                ...
                <ul className="text-blue-700 space-y-2 text-sm">
                  ...
                  <li>
                    • Your CPCS renewal test booking will be processed within 24
                    hours
                  </li>
                  <li>
                    • You can check your booking status using your Order ID
                  </li>
                  <li>• Test center will contact you with further details</li>
                  <li>
                    • Keep your CPCS card ready for verification on test day
                  </li>
                </ul>
              </div>
            )}
            ...
            {isProcessing && (
              <div className="bg-yellow-50 rounded-lg p-6 mb-8 text-left">
                ...
                <p className="text-yellow-700 text-sm">
                  ...
                  or navigate away. This page will automatically update once the
                  payment is complete.
                </p>
              </div>
            )}
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-500">
                Need help? Contact our support team or save your Order ID:{" "}
                <span className="font-medium">{sessionData?.orderId}</span>
              </p>
            </div>
          </div>
        </div>
...
export default CpcsPaymentResponse;
