// src/pages/payment/TestPaymentResponse.jsx
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Processing test payment...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              {isSuccess
                ? "Your CSCS test booking payment has been processed successfully."
            ...
            {isSuccess && (
              <div className="bg-blue-50 rounded-lg p-6 mb-8 text-left">
                ...
                <ul className="text-blue-700 space-y-2 text-sm">
                  ...
                  <li>• Your test booking will be processed within 24 hours</li>
                  <li>
